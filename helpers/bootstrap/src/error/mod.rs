//! ## Errors
//! Module for configuring and installing pretty, colorized error and panic reporting
//! using the [`color-eyre`](../../color_eyre/index.html) crate.
...
/// backtraces, etc...
///
/// Function should be first called in `main()`, so all errors and panics are reported
